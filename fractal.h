...
/*   Updated: 2020/03/08 23:28:30 by elfetoua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define BURNINSHI (fractal->type == 8)
# define F2 (fractal->type == 16)
# define F3 (fractal->type == 32)
...
void		*f1_set1(void *fractal);
void		*f1_set2(void *fractal);
void		*f1_set3(void *fractal);
void		*f1_set4(void *fractal);
